...
@section('content')
    ...
    <a href="{{route('repartidor.EstadoComanda.create')}}" class="btn btn-info"> Registar nuevo estado</a><hr>
        ...
        @foreach($data as $estado)
            <tr>
                ...
                <td><a href=" {{ route('repartidor.EstadoComanda.edit', $estado->id) }} " class="btn btn-warning"><span class="glyphicon glyphicon-edit" aria-hidden="true"></span></a>
                    <a href=" {{ route('repartidor.EstadoComanda.destroy', $estado->id) }}" class="btn btn-danger" ><span class="glyphicon glyphicon-remove" aria-hidden="true"></span></a></td>
            </tr>
